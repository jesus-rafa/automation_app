...
//   //const btnMenu = document.getElementById("btMenu").getAttribute('aria-expanded');
...
//       flag = document.getElementById("btMenu").getAttribute("aria-expanded");

//       if (flag) bsCollapse.toggle();
//     });
//   });
// }
